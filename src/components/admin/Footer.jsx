                ...
                <div className="row">
                    <div className="col-lg-4 col-md-4 col-sm-9">
                        <section className="footer-item">
                            <a href="home-03-green.html" className="logo footer-logo"><img src="/assets/images/Logo.jpg" alt="biolife logo" width="145" height="40"/></a>
                                ...
                                <ul className="contact-lines">
                                    ...
                                    <li>
                                        <p className="info-item">
                                            ...
                                            <b className="desc">Phone: (+94) (81) 2447441</b>
                                        </p>
                                    </li>
                                    <li>
                                        <p className="info-item">
