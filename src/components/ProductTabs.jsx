            ...
            <div className="product-tab z-index-20 sm-margin-top-193px xs-margin-top-30px">
                <div className="container">
                    <div className="biolife-title-box">
                        <span className="subtitle" style={{fontSize:"25px"}}>All the best item for You</span>
                        <h3 className="main-title" style={{fontSize:"60px"}}>Related Products</h3>
                    </div>
                        ...
                        <div className="tab-head tab-head__icon-top-layout icon-top-layout">
                            <ul className="tabs md-margin-bottom-35-im xs-margin-bottom-40-im">
                                <li className="tab-element active">
                                    <a href="#tab01_1st" className="tab-link"><span className="biolife-icon icon-lemon"></span>Fruits & Nuts</a>
                                </li>
                                <li className="tab-element" >
                                    <a href="#tab01_2nd" className="tab-link"><span className="biolife-icon icon-grape2"></span>Butter & Eggs</a>
                                </li>
                                <li className="tab-element" >
                                    <a href="#tab01_3rd" className="tab-link"><span className="biolife-icon icon-blueberry"></span>Berries</a>
                                </li>
                                <li className="tab-element" >
